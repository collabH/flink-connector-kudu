 ...
 */
package org.colloh.flink.kudu.connector;
...
import org.colloh.flink.kudu.connector.internal.writer.RowOperationMapper;
...
public class KuduTestBase {
    ...
    protected List<Row> readRows(KuduTableInfo tableInfo) throws Exception {
        ...
        RowResultRowConvertor rowResultRowConvertor = new RowResultRowConvertor();
        KuduReader<Row> reader = new KuduReader<>(tableInfo, readerConfig, rowResultRowConvertor);
