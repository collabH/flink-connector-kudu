...
import org.colloh.flink.kudu.connector.internal.writer.TupleOperationMapper;
import org.colloh.flink.kudu.connector.table.KuduDynamicTableSourceSinkFactory;
...
public class KuduCatalogTest extends KuduTestBase {
    ...
    public void dataStreamEndToEstTest() throws Exception {
        ...
        KuduDynamicTableSourceSinkFactory tableFactory = catalog.getKuduTableFactory();
        ...
        CollectionSink.output.clear();
//        tableFactory.createDynamicTableSource(path, table)
//                .getDataStream(env)
