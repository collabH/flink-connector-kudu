...
import org.colloh.flink.kudu.connector.KuduTestBase;
 ...
 */
public class KuduDynamicTableSourceTest extends KuduTestBase {
    private KuduDynamicTableSource kuduDynamicTableSource;
...
//        try {
////            kuduDynamicTableSource = catalog.getKuduTableFactory().createTableSource(op, catalog.getTable(op));
...
//        TableSchema tableSchema = kuduDynamicTableSource.getTableSchema();
...
//        DataType producedDataType = kuduDynamicTableSource.getProducedDataType();
...
//        KuduDynamicTableSource projectedTableSource = (KuduDynamicTableSource) kuduDynamicTableSource.projectFields(
//                new int[]{3, 4, 1});
//        // ensure copy is returned
//        assertTrue(kuduDynamicTableSource != projectedTableSource);
//        // ensure table schema is identical
//        assertEquals(kuduDynamicTableSource.getTableSchema(), projectedTableSource.getTableSchema());
...
//        KuduDynamicTableSource filteredTableSource = (KuduDynamicTableSource) kuduDynamicTableSource.applyPredicate(preds);
...
//        // ensure copy is returned
//        assertNotSame(kuduDynamicTableSource, filteredTableSource);
//        // ensure table schema is identical
//        assertEquals(kuduDynamicTableSource.getTableSchema(), filteredTableSource.getTableSchema());
//        // ensure return type is identical
//        assertEquals(kuduDynamicTableSource.getProducedDataType(), filteredTableSource.getProducedDataType());
//        // ensure filter pushdown is correct
//        assertTrue(filteredTableSource.isFilterPushedDown());
//        assertFalse(kuduDynamicTableSource.isFilterPushedDown());
    }
