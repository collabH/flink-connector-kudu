 ...
 */
package org.colloh.flink.connectors.kudu.batch;
...
class KuduInputFormatTest extends KuduTestBase {
    ...
    void testInvalidKuduMaster() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> new KuduRowInputFormat(null, new RowResultRowConvertor(), tableInfo));
    }
    ...
    void testInvalidTableInfo() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> new KuduRowInputFormat(readerConfig, new RowResultRowConvertor(), null));
    }
    ...
    private List<Row> readRows(KuduTableInfo tableInfo, String... fieldProjection) throws Exception {
        String masterAddresses = harness.getMasterAddressesAsString();
        KuduReaderConfig readerConfig = KuduReaderConfig.Builder.setMasters(masterAddresses).build();
        KuduRowInputFormat inputFormat = new KuduRowInputFormat(readerConfig, new RowResultRowConvertor(), tableInfo, new ArrayList<>(),
