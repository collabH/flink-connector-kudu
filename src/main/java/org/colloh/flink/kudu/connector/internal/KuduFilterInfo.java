 ...
 */
package org.colloh.flink.kudu.connector.internal;
...
public class KuduFilterInfo implements Serializable {
    ...
    private KuduPredicate predicateComparator(ColumnSchema column) {
        ...
        switch (column.getType()) {
            case STRING:
                String data;
                if (this.value instanceof BinaryStringData) {
                    BinaryStringData strVal = (BinaryStringData) this.value;
                    data = strVal.getJavaObject();
                } else {
